...
--
-- Host: localhost
-- Generation Time: Nov 15, 2016 at 09:26 
...
(1, 'Programming F# 3.0, 2nd Edition', 2012, 'Educational'),
(2, 'Regular Expressions Cookbook, 2nd Edition', 2012, 'Programming'),
(3, 'Head First Networking', 2009, 'Educational'),
(4, 'The Art of Concurrency', 2009, 'Educational'),
(5, '97 Things Every Programmer Should Know', 2010, 'Programming'),
(9, 'Gera knyga', 2011, 'SCI-FI'),
(10, 'Knyga', 2001, 'Action');
